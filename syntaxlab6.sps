...
EXAMINE VARIABLES=ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 
    ar17 ar18 ar19 ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27 ar28 liberal sex
...
*regression with saved mahalanobis distance
...
*DELETED FOUR PARTICIPANTS WITH MISSING VALUES MANUALLY

*computing p values of chi squared for each case

COMPUTE pval=($CASENUM-0.5)/150.
EXECUTE.

*computing chi squared values corresponding to the p values

COMPUTE chisq=IDF.CHISQ(pval,28).
EXECUTE.

* Chart Builder. scatterplot of chi square and mahalnobis
...
*factor analysis with scree plot
...
*EXPLORATORY PARALLEL ANALYSIS with 1000 iterations, compute type 2, rand typ 2
...
save results /outfile= '/Users/tiinarajala/Desktop/lab 6\screedata.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= '/Users/tiinarajala/Desktop/lab 6\screedata.sav'.
TSPLOT VARIABLES= rawdata means percntyl /ID= root /NOLOG.


*PRRINCIPAL COMPONENT PARALLEL ANALYSIS compute type 1 rand type 2

* Encoding: UTF-8.
*parallel analysis with 1000 iterations, compute type 2, rand typ 2
...
save results /outfile= '/Users/tiinarajala/Desktop/lab 6\screedata2.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= '/Users/tiinarajala/Desktop/lab 6\screedata2.sav'.
TSPLOT VARIABLES= rawdata means percntyl /ID= root /NOLOG.




****EXPLORING FACTOR ANALYSIS WITH DIFFERENT FACTORS****

*re-ran the factor analysis with principal axis factoring
...
*factor analysis with 5 factors no rotation
...
*factor analysis (PAF) with promax rotation, 5 factors
...
*factor analysis (PAF) with promax rotation, 4 factors
...
*factor analysis (PAF) with promax rotation, 3 factors
...
*factor analysis (PAF) with promax rotation, 3 factors: excluding ar28
...
*factor analysis (PAF) with promax rotation, 3 factors, excluding: ar28, ar1

FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
*factor analysis (PAF) with promax rotation, 3 factors, excluding: ar28, ar1, ar14

FACTOR
  /VARIABLES ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar3 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
*factor analysis (PAF) with promax rotation, 3 factors, excluding: ar28, ar1, ar14, ar3

FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar7 ar8 ar9 ar10 ar11 ar12 ar13 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
  /FORMAT SORT
  /PLOT EIGEN
...
*factor analysis 2 factors excluded: ar8

  FACTOR
  /VARIABLES ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27 ar28
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar3 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27 ar28
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
   /FORMAT SORT
  /CRITERIA FACTORS(2) ITERATE(25)
...
*factor analysis 2 factors excluded: ar8, ar28
...
*factor analysis 2 factors excluded: ar8, ar28, ar3

  FACTOR
  /VARIABLES ar1 ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
   /FORMAT SORT
  /CRITERIA FACTORS(2) ITERATE(25)
...
*factor analysis 2 factors excluded: ar8, ar28, ar3, ar1

  FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar14 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
   /FORMAT SORT
  /CRITERIA FACTORS(2) ITERATE(25)
...
*factor analysis 2 factors excluded: ar8, ar28, ar3, ar1, ar 14

  FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
   /FORMAT SORT
  /CRITERIA FACTORS(2) ITERATE(25)
...
*factor analysis 2 factors excluded: ar8, ar28, ar3, ar1, ar 14, ar12

  FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar13 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar13 ar15 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
   /FORMAT SORT
  /CRITERIA FACTORS(2) ITERATE(25)
...
*factor analysis 2 factors excluded: ar8, ar28, ar3, ar1, ar 14, ar12, ar15

  FACTOR
  /VARIABLES ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar13 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar2 ar4 ar5 ar6 ar7 ar9 ar10 ar11 ar13 ar16 ar17 ar18 ar19 
    ar20 ar21 ar22 ar23 ar24 ar25 ar26 ar27
  /PRINT UNIVARIATE INITIAL EXTRACTION ROTATION
   /FORMAT SORT
  /CRITERIA FACTORS(2) ITERATE(25)
...
*saving factors (regression method)
...
*regression with two final factor structures DV: liberal
